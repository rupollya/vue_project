        ...
        <div class="form-container m-5">
          ...
          <form action="#" @submit.prevent="handleSubmit">
            ...
            <div class="">
              ...
              <!-- Поле ввода логина -->
              <input class="user-input" placeholder="логин" type="text" id="login" v-model="login"
                @input="validatelogin" required maxlength="10" />
            ...
            <div class="">
              ...
              <!-- Поле ввода пароля -->
              <input type="password" placeholder="пароль" id="password" v-model="password" @input="validatePassword"
                required maxlength="10" />
              <div v-if="passwordError" class="error-message">{{ passwordError }}</div>
            </div>
            <!-- Кнопка и переключатель формы -->
            <button  id="regauthbutton" type="submit" class="btn btn-light w-100" :disabled="!formValid">{{ isLogin ? 'Войти' :
              'Зарегистрироваться' }}</button>
            <p id="backforth" class="text-center mt-2" @click="toggleForm" style="cursor: pointer;">
...
// интерфейс для обработки вводимых данных
...
export default defineComponent({
  ...
  methods: {
    // Функция для удаления всех правил стилей css
    beforeCreate() {
    ...
    // Функция для определения, что будет написано в кнопке
    toggleForm(): void {
    ...
    // валидация вводимых данных для логина
    validatelogin(): void {
    ...
    // валдация вводимых данных для пароля
